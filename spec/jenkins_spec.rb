...
describe 'get build data from jenkins' do
  ...
  before(:each) do
    ...
    stub_request(:get, 'http://ci.babajob.com:9090/view/Platform/job/Platform-Build/api/json?tree=builds[status,timestamp,id,result,duration,url,fullDisplayName]').
